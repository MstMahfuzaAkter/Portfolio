  ...
  const tabData = {
    Introduction: (
      <div className="space-y-6 animate-fadeIn">
        ...
        <p className="text-gray-400 leading-relaxed text-lg">
          I’m <span className="text-teal-400 font-bold">Mahfuza</span>, a MERN Stack developer
    ...
    WhatIDo: (
      <div className="space-y-6 text-gray-400 animate-fadeIn pt-4">
        {[
          { icon: "💻", text: "Building full-stack web applications using the MERN stack." },
          { icon: "⚛️", text: "Developing scalable and reusable React components." },
          { icon: "🧠", text: "Solving problems through data structures and algorithms." },
          { icon: "🛠️", text: "Designing RESTful APIs and backend logic with Node.js & Express." },
          { icon: "🎨", text: "Creating clean, responsive, and user-friendly UI designs." },
          { icon: "🚀", text: "Deploying and optimizing applications for production." }
        ]
          .map((hobby, i) => (
              ...
              <div className="flex p-3 bg-black/20 gap-2">
                {Object.keys(tabData).map((tab) => (
                  <button
                    ...
                    className={`flex-1 py-3 text-[10px] font-black tracking-[2px] uppercase rounded-2xl transition-all duration-500 ${activeTab === tab
